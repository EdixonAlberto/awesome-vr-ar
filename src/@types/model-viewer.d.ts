...
interface ModelViewer extends Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>, 'ref'> {
  /**
  ...
  ref?: React.MutableRefObject<import('@google/model-viewer/lib/model-viewer').ModelViewerElement | undefined>
}
